...
<table width="1000" height="521" border="10">
  <tbody>
    <tr>
      <td width="939" height="229" align="center" valign="top" bgcolor="#B51E1E"><h2>CARRO DE COMPRAS</h2>
...
header("location:factura.php?idpersona=$rows[0]");
...
$conexion=mysqli_connect($db_host,$db_usuario,$db_pass,$db_nombre);
	if(mysqli_connect_errno($db_nombre)){
		...
		$agregar="INSERT INTO carro VALUES('','$id_persona','$id_articulo')";
