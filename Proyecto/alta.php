...
<table width="1000" height="537" border="10">
  <tbody>
    <tr>
      <td width="939" height="229" align="center" valign="top" bgcolor="#04453E"><h2>ALTA ARTICULO</h2>
    ...
    <tr>
      <td width="949" height="246" align="left" valign="top" bgcolor="#079046">
        <p>
          <?php
$nombre=$_POST['nombre'];
...
$conexion=mysqli_connect($db_host,$db_usuario,$db_pass,$db_nombre);
	if(mysqli_connect_errno($db_nombre)){
		...
		$registrar="INSERT INTO articulo VALUES('','$nombre','$deporte','$costo','$descripcion','$imagen')";
...
?>
      ...
      <p>&nbsp;</p>
      <p><a href="menu.html">Regresar a Menu</a></p>
      <p><a href="index.html">Ir a Página Principal</a></p></td>
    </tr>
  </tbody>
</table>
</body>
