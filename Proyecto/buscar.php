...
<table width="1000" height="568" border="10">
  <tbody>
    <tr>
      <td width="939" height="229" align="center" valign="top" bgcolor="#04453E"><h2>BUSCAR ARTICULO</h2>
    ...
    <tr>
      <td width="949" height="277" align="left" valign="top" bgcolor="#079046">
        <h6>
          <?php
$nombre=$_POST['nombre'];
...
$conexion=mysqli_connect($db_host,$db_usuario,$db_pass,$db_nombre);
	if(mysqli_connect_errno($db_nombre)){
		...
		$busqueda="SELECT * FROM articulo WHERE DISCIPLINA = '$deporte' AND NOMBRE = '$nombre'";
...
?>
        ...
        <h6><a href="modificar.html">Modificar</a> o
          <a href="eliminar.html">Eliminar</a>        </h6>
        <h5>NOTA: Si deseo modificar o eliminar el artículo, deberá de anotar el ID del Artículo, ya que lo necesitará para hacer los cambios necesarios.</h5>
        <h5><a href="menu.html">Regresar a Menú</a></h5>
