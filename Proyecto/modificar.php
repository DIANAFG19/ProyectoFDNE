...
<table width="1000" height="496" border="10">
  <tbody>
    <tr>
      <td width="939" height="229" align="center" valign="top" bgcolor="#04453E"><h2>MODIFICAR ARTICULO</h2>
    ...
    <tr>
      <td width="949" height="205" align="left" valign="top" bgcolor="#079046">
        <h6>
          <?php
$id=$_POST['id'];
$campo=$_POST['campo'];
...
$conexion=mysqli_connect($db_host,$db_usuario,$db_pass,$db_nombre);
	if(mysqli_connect_errno($db_nombre)){
		...
		$modificar="UPDATE articulo SET '$campo' = '$valor' WHERE ID_ARTICULO = '$id'";
...
?>
        ...
        <h6>&nbsp;</h6>
        <h5><a href="buscar.php">Regresar</a></h5>
        <h5><a href="index.html">Ir a página Principal</a></h5>
      <h5>&nbsp;</h5></td>
    </tr>
  </tbody>
</table>
