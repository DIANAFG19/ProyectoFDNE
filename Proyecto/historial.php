...
<table width="1000" height="387" border="10">
  <tbody>
    <tr>
      <td width="939" height="229" align="center" valign="top" bgcolor="#B51E1E"><h2>HISTORIAL DE COMPRAS</h2>
    ...
    <tr>
      <td width="949" height="68" align="left" valign="top" bgcolor="#4E1919">
        <h6>
          <?php
...
$conexion=mysqli_connect($db_host,$db_usuario,$db_pass,$db_nombre);
	if(mysqli_connect_errno($db_nombre)){
		...
		$busqueda="SELECT articulo.NOMBRE FROM articulo, persona, carro WHERE persona.id_persona = carro.pid_persona AND articulo.id_articulo = carro.aid_articulo AND carro.pid_persona = '$id_persona' ";
	...
	mysqli_close($conexion);
		  ?> </h6>
      <h5><a href="compras.html">Regresar</a></h5></td>
    </tr>
  </tbody>
</table>
</body>
