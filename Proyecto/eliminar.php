...
<table width="1000" height="568" border="10">
  <tbody>
    <tr>
      <td width="939" height="229" align="center" valign="top" bgcolor="#04453E"><h2>ELIMINAR ARTICULO</h2>
...
$conexion=mysqli_connect($db_host,$db_usuario,$db_pass,$db_nombre);
	if(mysqli_connect_errno($db_nombre)){
		...
		$eliminar="DELETE FROM articulo WHERE ID_ARTICULO = '$id'";
...
?>
        ...
        <p>&nbsp;</p>
        <p><a href="buscar.php">Regresar</a></p>
        <p><a href="index.html">Ir a página Principal</a></p>
      <p>&nbsp;</p></td>
    </tr>
  </tbody>
</table>
