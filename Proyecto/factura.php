...
<table width="1000" height="521" border="10">
  <tbody>
    <tr>
      <td width="939" height="229" align="center" valign="top" bgcolor="#B51E1E"><h2>FACTURA</h2>
...
$conexion=mysqli_connect($db_host,$db_usuario,$db_pass,$db_nombre);
	if(mysqli_connect_errno($db_nombre)){
		...
		echo "FACTURA<br><br>";
		$consulta="SELECT persona.NOMBRE, articulo.NOMBRE, articulo.COSTO FROM persona,articulo,carro WHERE persona.id_persona = carro.pid_persona AND articulo.id_articulo = carro.aid_articulo AND persona.ID_PERSONA='$id_persona'";
		$resultado=mysqli_query($conexion,$consulta);
		while($rows=mysqli_fetch_array($resultado)){ 
				echo "ARTICULO: ".$rows[1]."<br>";
				echo "PRECIO: ".$rows[2]."<br>";
			}
	}
mysqli_close($conexion);
?>
          </h6>
        <h5><a href="factura.php">Finalizar Compras</a></h5>
